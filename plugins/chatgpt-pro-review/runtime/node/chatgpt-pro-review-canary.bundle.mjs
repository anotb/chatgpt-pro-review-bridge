...
import { mkdtemp, readFile as readFile5, rename, rm as rm2, stat as stat8, writeFile as writeFile4 } from "node:fs/promises";
...
import { copyFile as copyFile3, link as link2, mkdir as mkdir4, readFile as readFile3, rm, stat as stat6, writeFile as writeFile3 } from "node:fs/promises";
...
async function readArchivedSubmission(archiveDirectory) {
  const value = JSON.parse(await readFile5(join6(archiveDirectory, "submission.json"), "utf8"));
