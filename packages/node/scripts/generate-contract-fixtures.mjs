...
const BLOCKER_EXPLANATION_PROFILES = [
  ...
  { kind: "model_unavailable", title: "Requested model unavailable", category: "model", severity: "action_required", userActionRequired: true },
  { kind: "model_fallback", title: "Model fallback detected", category: "model", severity: "blocked", userActionRequired: true },
  { kind: "configuration_restore_failed", title: "Configuration restoration failed", category: "configuration", severity: "action_required", userActionRequired: true },
