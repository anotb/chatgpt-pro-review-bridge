...
```bash
python -m pip install https://github.com/anotb/chatgpt-pro-review-bridge/releases/download/v0.7.18/chatgpt_pro_review_bridge-0.7.18-py3-none-any.whl
```

The Python package needs a Node backend command for browser-control workflows. Install or build the Node package too:

```bash
npm install chatgpt-pro-review-bridge@0.7.18
```
