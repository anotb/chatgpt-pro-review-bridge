...
For a manual install, add this repository as a marketplace pinned to `v0.7.14` with `codex plugin marketplace add anotb/chatgpt-pro-review-bridge --ref v0.7.14`, then install it with `codex plugin add chatgpt-pro-review@chatgpt-pro-review-bridge`.
